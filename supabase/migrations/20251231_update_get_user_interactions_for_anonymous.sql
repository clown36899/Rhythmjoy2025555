-- Update get_user_interactions RPC function to include anonymous board and comment interactions
-- This allows the UI to highlight posts and comments that the user has interacted with.
