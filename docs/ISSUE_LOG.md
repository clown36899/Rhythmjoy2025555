...
- 관련 결정: `docs/decisions/2026-08-27-ingestion-registration-completeness.md`
- 관련 파일: `scripts/ingestion/candidate-utils.mjs`, `scripts/ingestion/ai-candidate-adjudicator.mjs`, `scripts/ingestion/auto-registration-report.mjs`, `scripts/ingestion/swing-daily-native.mjs`, `scripts/ingestion/swing-social-map.mjs`, 관련 테스트
