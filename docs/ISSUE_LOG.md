...
- 기준 데이터: 9/16 이후 수집 원장 연계 공개 일정 28건 중 ID/지도 링크 누락 26건. 사보이 중복 1건 제거 뒤 27건/누락 25건. 장소 목록과 유일하게 일치하는 15건, 나머지 10건은 현재 장소 레코드 미등록 또는 추출 장소 불명확(클럽 라틴 3, 강남역 라틴바 3, 아지트 연습실·원스빠·패스트엔터테인먼트·골든스윙 각 1). 자동·관리자 등록 후보가 섞여 있으며 숫자를 자동등록 건수로 단정하지 않는다.
