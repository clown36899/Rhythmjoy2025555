...
- 조치:
  ...
  - 3단계 스윙 혜택 검색을 무료 강습·입장·워크숍·동호회 혜택, 할인·특가·얼리버드·쿠폰, 바·동호회·댄스홀 정기권/패스 등 14개 검색 축으로 확장했다.
  - 할인 후보는 명시적 할인 문구·미래 날짜·원문 URL이 확인되면 이미지가 없어도 검수 후보로 저장하고 이미지 보완 경고를 남긴다. 무료·정기권 후보는 이미지 필수를 유지한다.
