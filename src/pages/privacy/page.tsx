    ...
    return (
        <div className="PrivacyPage">
            ...
            <div className="privacy-content">
                <section>
                    <h2 className="privacy-section-title">1. 개인정보의 처리 목적</h2>
                    ...
                    <ul className="privacy-list">
                        ...
                        <li>서비스 품질 개선, 부정 이용 방지, 장애 분석을 위한 접속 및 이용 기록 확인</li>
                    </ul>
                </section>

                <section>
                    <h2 className="privacy-section-title">2. 처리하는 개인정보의 항목</h2>
                    <p>서비스는 카카오 로그인을 통해 다음과 같은 정보를 수집합니다:</p>
                    <ul className="privacy-list">
                        <li>필수항목: 닉네임, 이메일, 이름, 성별, 생일, 전화번호(카카오계정)</li>
                        <li>선택항목: 출생연도, 프로필 이미지(카카오 설정에 따름)</li>
                        <li>자동수집항목: 접속 일시, 접속 경로, 페이지 이동 및 버튼/링크 클릭 기록, 브라우저/기기 정보, IP 주소 또는 IP 해시, 비회원 기기 식별용 임의값</li>
                        <li>* 위 정보는 카카오 로그인 시 동의를 거쳐 제공받습니다.</li>
                    </ul>
                </section>

                <section>
                    <h2 className="privacy-section-title">3. 개인정보의 보유 및 이용 기간</h2>
                    <p>서비스는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</p>
                    <ul className="privacy-list">
                        <li>회원 탈퇴 시까지</li>
                        <li>운영/보안 목적의 접속 및 이용 기록: 수집일로부터 최대 1년 또는 관련 분쟁 처리 완료 시까지</li>
                        <li> 관계 법령 위반에 따른 수사·조사 등이 진행 중인 경우에는 해당 수사·조사 종료 시까지</li>
                    </ul>
                </section>

                <section>
                    <h2 className="privacy-section-title">4. 개인정보의 파기 절차 및 방법</h2>
                    <p>서비스는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</p>
                </section>

                <section>
                    <h2 className="privacy-section-title">5. Google Analytics 사용</h2>
                ...
                <section>
                    <h2 className="privacy-section-title">6. 문의처</h2>
                    <p>개인정보 처리와 관련한 문의는 아래로 연락주시기 바랍니다.</p>
                    <p className="privacy-contact">clown313@naver.com</p>
                </section>
            </div>
        </div>
    );
