        ...
        if (activeTab === 'social') {
            ...
            try {
                ...
                const eventData: any = {
                    ...
                    group_id: (groupId && groupId !== -1) ? groupId : (editSchedule?.group_id && editSchedule.group_id !== -1 ? editSchedule.group_id : null),
                    user_id: user.id,
                    category: dbCategory,
                    genre: genre,
                    day_of_week: null
        ...
        >
            <div className="social-schedule-modal-container" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="ssm-tabs">
                    ...
                    {(!editSchedule && groupId && groupId !== -1) && ( // 단체가 있을 때만 모집 탭 노출
                        <button
