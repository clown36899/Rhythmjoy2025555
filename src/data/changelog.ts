...
export const changelogData: ChangelogVersion[] = [
    {
        ...
        date: '2026-02-17',
        changes: [
            '[✨ Feature] 이벤트 수집기 전체 선택(Select All) 기능 구현',
            '[🔧 DB] 수집 데이터 DB 영구 삭제 시스템 구축 (scraped_events 테이블 전환)',
            '[🚀 Performance] 이벤트 삭제 시 캘린더 캐시 무효화 및 메인 v2 실시간 동기화'
        ]
    },
    {
        version: '3.8.4',
        date: '2026-02-15',
        changes: [
            '[🔧 PWA] 서비스 워커 캐시 무효화 로직 보강 및 오프라인 정합성 최적화'
        ]
    },
    {
        version: '3.8.3',
        date: '2026-02-09',
        changes: [
            '[✨ Feature] 소셜 일정 등록 라우팅 연동 (소셜 페이지로 이동 후 모달 오픈)',
            '[🎨 UI] 소셜 등록 진입점 표준화 및 캘린더 날짜 자동 연동 기능 구현',
            '[🔧 PWA] 서비스 워커 버전 업데이트 및 캐시 갱신 (리다이렉트 로직 반영)'
        ]
    },
    {
        version: '3.8.2',
    ...
    },
    {
        ...
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 스윙씬 통계 정확도 대폭 개선 (등록일 → 활동일 기준 변경)',
            '[📊 Stats] Data Inspector 고도화 (모달 적용, 정렬 로직 분리)',
            '[📊 Stats] 장르 통계에서 게시글 제외 및 "기타" → "소셜" 명칭 변경',
            '[🐛 Fix] 멀티 데이 이벤트 및 소셜 일정 중복 집계 오류 수정'
        ]
    },
    {
        version: '3.7.11',
    ...
    },
    {
        ...
        date: '2026-01-23',
        changes: [
            '주간 통계에서 등록일(created_at) 기준 완전 제거',
            '다중 날짜 이벤트(금~일) 모든 요일 집계 적용',
            '날짜 미기재 콘텐츠 통계 제외 처리'
        ]
    },
    {
        ...
        date: '2026-01-23',
        changes: [
            '소셜 장르 미반영 버그 수정 (기타 장르 비율 정상화)',
            '주간 통계 집계 기준 변경: 등록일 -> 활동일(요일)'
        ]
    },
    {
        version: '3.7.8',
    ...
    },
    {
        ...
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 주간 통계 기간 필터(전체/이번 달) 탭 메뉴 신설',
            '[📊 Stats] 차트별 직하단 분석 설명 배치로 가독성 개선',
            '[🔧 Stats] 6개월/1개월 데이터 이원화 분석 시스템 구축'
        ]
    },
    {
        version: '3.7.6',
        date: '2026-01-23',
        changes: [
            '[🎨 Stats] 장르별 컬러 중복 문제 해결 및 동적 할당 로직 적용',
            '[📊 Stats] 유형별(소셜, 행사 등) 주간 피크 분석 데이터 추가',
            '[🔧 Stats] 텍스트 기반 시각화 리포트 최적화'
        ]
    },
    {
        version: '3.7.5',
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 요일별 콘텐츠 유형(강습/행사 등) 분포 차트 추가',
            '[🎨 Stats] 장르별 컬러 팔레트 선명화 및 회색 중복 문제 해결',
            '[📊 Stats] 월간-주간(유형)-주간(장르) 3단계 분석 구조 완성'
        ]
    },
    {
        version: '3.7.4',
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 월별 카테고리(강습/행사 등) 통계 그래프 원복 완료',
            '[📊 Stats] 요일별 장르 비중 통계 특화 및 정보 분석 이원화',
            '[🐞 Fix] 차트 레이아웃 및 코드 데이터 집계 로직 무결성 강화'
        ]
    },
    {
        version: '3.7.3',
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 요일별 장르 구성을 한눈에 보는 "스택형 차트" 도입',
            '[🎨 Stats] 장르별 고유 컬러 시스템 적용으로 시각적 직관성 강화',
            '[💡 Stats] 장르별 피크 타임(최적 요일) 분석 정보 추가'
        ]
    },
    {
        version: '3.7.2',
        date: '2026-01-23',
        changes: [
            '[📅 Stats] 요일별 장르 심층 분석 도입 (요일별 최다 장르 표시)',
            '[📉 Stats] "요일별 집중 분석" 섹션 고도화 및 데이터 태그 추가',
            '[💡 Stats] 구체적인 요일-장르 매칭 방식의 데이터 인사이트 제공'
        ]
    },
    {
        version: '3.7.1',
        date: '2026-01-23',
        changes: [
            '[📈 Stats] 월별 콘텐츠(강습/행사/소셜) 스택형 차트 도입',
            '[📅 Stats] 요일별 주요 활동 분석 표시 및 UI 개선',
            '[🏷️ Stats] 인기 장르 TOP 5 비중 분석 차트 추가',
            '[🐞 Fix] 통계 그래프가 보이지 않던 레이아웃 이슈 해결'
        ]
    },
    {
        version: '3.7.0',
        date: '2026-01-23',
        changes: [
            '[📊 Stats] 게시물 통계 내 "스윙씬 통계" 탭 추가',
            '[📈 Analytics] 월별 콘텐츠 등록 추이 및 요일별 활성도 지수 도입',
            '[🕒 Analytics] 일평균 등록 건수 등 데이터 인사이트 제공'
        ]
    },
    {
        version: '3.6.2',
    ...
    },
    {
        ...
        date: '2026-01-09',
        changes: [
            '[🐛 Fix] 동호회 강습 캘린더 분류 오류 수정 (행사 탭 → 강습 탭)',
            '[🐛 Fix] 캘린더 소셜 일정 카테고리 필터링 정교화',
            '[🔧 개선] 전체적인 TypeScript 타입 안전성 강화 및 경고 제거',
            '[✨ 기능] 캘린더 월(Month) 헤더 클릭 시 \'오늘\'로 이동 기능 추가'
        ]
    },
    {
        version: '3.5.0',
