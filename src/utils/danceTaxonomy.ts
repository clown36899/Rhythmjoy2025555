...
const genreRules: MatchRule[] = [
  ...
  { key: 'salsa', label: '살사', family: 'partner', patterns: [/살사/i, /\bsalsa\b/i, /강턴/i, /홍턴/i, /보니따/i, /하바나/i, /sol\s*바/i, /sol바/i, /까리베/i] },
  { key: 'bachata', label: '바차타', family: 'partner', patterns: [/바차타/i, /\bbachata\b/i, /강턴/i, /홍턴/i, /보니따/i, /하바나/i, /sol\s*바/i, /sol바/i, /까리베/i] },
  { key: 'tango', label: '탱고', family: 'partner', patterns: [/탱고/i, /\btango\b/i, /밀롱가/i, /milonga/i, /루미노소/i, /월나다/i, /오나다/i, /까사밀롱가/i, /solo\s*tango/i, /오초/i, /라벤따나/i, /우나베스/i, /쁘락띠까/i] },
...
const tagRules: Array<{ key: string; label: string; patterns: RegExp[] }> = [
  ...
  { key: 'battle', label: '배틀', patterns: [/배틀/i, /battle/i, /왁킹\s*배틀/i, /팝핀\s*배틀/i, /힙합\s*배틀/i] },
  ...
  { key: 'session', label: '세션', patterns: [/세션/i, /session/i, /연습\s*세션/i] },
