...
const PROD_VERBOSE_ALLOW_RE = /\[(?:Kakao Callback|Auth|DataClient|Stats#|SW|CalendarPage|Push|PushSave|NotificationSettingsModal)\]|Safety Net|SIGNED_|TOKEN_REFRESHED|INITIAL_SESSION|사용자 조작 감지|setSession/i;
