            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                <input
                  ...
                  required
                  className="w-full bg-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-[#888]"
              ...
              <div className="bg-orange-900/20 border border-orange-700/50 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-orange-400 text-sm font-bold">
