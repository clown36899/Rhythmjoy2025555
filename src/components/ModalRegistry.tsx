...
const WeeklySocialModal = lazy(() => import('../pages/v2/components/WeeklySocialModal'));
const SocialNoticeModal = lazy(() => import('../pages/v2/components/SocialNoticeModal'));
...
const SocialDayMapModal = lazy(() => import('../pages/social/components/SocialDayMapModal'));
...
const ExternalApiPartnerManagementModal = lazy(() => import('../components/ExternalApiPartnerManagementModal'));
...
const MODAL_COMPONENTS: Record<string, any> = {
    ...
    'weeklySocial': WeeklySocialModal,
    'socialNotice': SocialNoticeModal,
    ...
    'socialDayMap': SocialDayMapModal,
    ...
    'externalApiPartnerManagement': ExternalApiPartnerManagementModal,
};
