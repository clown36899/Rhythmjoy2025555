...
export const collectionSources = [
  ...
  source({ id: 'swingfriends-cafe', name: '스윙프렌즈 카페', scope: 'swing', genre: 'swing', type: 'naver_cafe', url: 'https://cafe.naver.com/f-e/cafes/10026855/menus/85?viewType=L', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: ['social', 'class', 'event', 'sale'], priority: 2, notes: '복수 장소 이력이 있어 원문에 실제 장소가 명시되고 활동별 근거와 AI 98% 재검증을 통과한 후보만 자동등록한다.' }),
  ...
  source({ id: 'swing_friends', name: '스윙프렌즈 인스타그램', scope: 'swing', genre: 'swing', type: 'instagram', url: 'https://www.instagram.com/swing_friends/', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: ['social', 'class', 'event', 'sale'], priority: 2, notes: '포스터/본문에서 날짜·실제 장소·활동 근거가 함께 확인되고 AI 98% 재검증을 통과한 후보만 자동등록한다.' }),
  ...
  source({ id: 'swingtown-cafe', name: '스윙타운', scope: 'swing', genre: 'swing', type: 'naver_cafe', url: 'https://cafe.naver.com/f-e/cafes/10342583/menus/264?viewType=L', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: ['social', 'class', 'event'], priority: 2, runOrder: -0.45, notes: '스윙타운은 단체명이며 장소로 대체하지 않는다. 원문의 실제 장소·활동 근거와 AI 98% 재검증을 통과한 후보만 자동등록한다.' }),
