...
const source = ({
  ...
  benefitKind = '',
  venue = '',
  autoRegistrationPolicy = 'manual',
  autoRegistrationVenuePolicy = 'registry-or-explicit',
  autoRegistrationAllowedActivityTypes = null,
...
export const collectionSources = [
  ...
  source({ id: 'benefit-search-free-event', name: '무료 이벤트 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: 'https://www.google.com/search?q=site%3Ainstagram.com+%EB%A6%B0%EB%94%94%ED%95%A9+%EB%AC%B4%EB%A3%8C+%EC%9D%B4%EB%B2%A4%ED%8A%B8', query: 'site:instagram.com 린디합 무료 이벤트', benefitKind: 'free_event', priority: 3, runOrder: 0, notes: '3단계 혜택 전용 검색. 실제 Instagram 게시물 본문·날짜·원본 이미지를 다시 확인한다.' }),
  source({ id: 'benefit-search-free-line-class', name: '소셜 무료 라인강습 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 스윙 소셜 "무료 라인강습"')}`, query: 'site:instagram.com 스윙 소셜 "무료 라인강습"', benefitKind: 'free_event', priority: 3, runOrder: 0 }),
  source({ id: 'benefit-search-free-entry', name: '무료 입장·첫 방문 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 스윙댄스 "무료 입장" OR "첫 방문 무료"')}`, query: 'site:instagram.com 스윙댄스 "무료 입장" OR "첫 방문 무료"', benefitKind: 'free_event', priority: 3, runOrder: 0 }),
  source({ id: 'benefit-search-free-workshop', name: '무료 워크숍·체험 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 린디합 OR 발보아 "무료 워크샵" OR "무료 체험"')}`, query: 'site:instagram.com 린디합 OR 발보아 "무료 워크샵" OR "무료 체험"', benefitKind: 'free_event', priority: 3, runOrder: 0 }),
  source({ id: 'benefit-search-club-free', name: '동호회 무료 혜택 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 스윙 동호회 무료 체험 OR 무료 혜택')}`, query: 'site:instagram.com 스윙 동호회 무료 체험 OR 무료 혜택', benefitKind: 'free_event', priority: 3, runOrder: 0 }),
  source({ id: 'benefit-search-season-pass', name: '정기권 판매 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: 'https://www.google.com/search?q=site%3Ainstagram.com+%EC%8A%A4%EC%9C%99%EB%8C%84%EC%8A%A4+%EC%A0%95%EA%B8%B0%EA%B6%8C+%ED%8C%90%EB%A7%A4', query: 'site:instagram.com 스윙댄스 정기권 판매', benefitKind: 'season_pass', priority: 3, runOrder: 0, notes: '3단계 혜택 전용 검색. 실제 Instagram 게시물 본문·날짜·원본 이미지를 다시 확인한다.' }),
  ...
  source({ id: 'benefit-search-earlybird', name: '얼리버드·조기등록 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 스윙 린디합 얼리버드 OR 조기등록 할인')}`, query: 'site:instagram.com 스윙 린디합 얼리버드 OR 조기등록 할인', benefitKind: 'discount_event', priority: 4, runOrder: 0 }),
  source({ id: 'benefit-search-coupon', name: '쿠폰·프로모션 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: `https://www.google.com/search?q=${encodeURIComponent('site:instagram.com 스윙댄스 할인 쿠폰 OR 프로모션')}`, query: 'site:instagram.com 스윙댄스 할인 쿠폰 OR 프로모션', benefitKind: 'discount_event', priority: 4, runOrder: 0 }),
  source({ id: 'benefit-search-sale-event', name: '판매 이벤트 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: 'https://www.google.com/search?q=site%3Ainstagram.com+%EC%8A%A4%EC%9C%99%EB%8C%84%EC%8A%A4+%ED%8C%90%EB%A7%A4+%EC%9D%B4%EB%B2%A4%ED%8A%B8', query: 'site:instagram.com 스윙댄스 할인 판매 이벤트', benefitKind: 'discount_event', priority: 4, runOrder: 0, notes: '4단계 할인 전용 검색. 실제 게시물 본문·미래 날짜·할인 표현을 다시 확인한다.' }),
  ...[
    ...
    ['salsa-discount', '살사 할인 이벤트 검색', 'salsa', 'salsa', 'site:instagram.com 서울 살사 할인 OR 얼리버드 OR 쿠폰', 'discount_event'],
    ...
    ['bachata-discount', '바차타 할인 이벤트 검색', 'bachata', 'bachata', 'site:instagram.com 서울 바차타 할인 OR 얼리버드 OR 쿠폰', 'discount_event'],
    ...
    ['tango-discount', '탱고 할인 이벤트 검색', 'tango', 'tango', 'site:instagram.com 서울 탱고 할인 OR 얼리버드 OR 쿠폰', 'discount_event'],
    ...
    ['street-discount', '스트릿 할인 이벤트 검색', 'street', 'street', 'site:instagram.com 서울 스트릿댄스 할인 OR 얼리버드 OR 쿠폰', 'discount_event'],
  ...
  source({ id: 'neo_swing', name: '네오스윙 인스타그램', scope: 'swing', genre: 'swing', type: 'instagram', url: 'https://www.instagram.com/neo_swing/', venue: '해피홀', autoRegistrationPolicy: 'shadow', autoRegistrationAllowedActivityTypes: [], priority: 1, notes: '공식 Instagram 원본을 우선 확인한다. 승인 연결 표본 정확도가 95%에 도달하기 전에는 자동등록 준비 판정을 차단한다.' }),
  ...
  source({ id: 'sosyalclub_swing', name: 'The Social Club 수요 발보아', scope: 'swing', genre: 'balboa', type: 'instagram', url: 'https://www.instagram.com/thesocialcluba/', venue: '소셜클럽', autoRegistrationPolicy: 'shadow', autoRegistrationAllowedActivityTypes: [], allowedActivityTypes: ['social'], allowedWeekdays: [3], requiredEventPattern: /balboa\s+in\s+(?:the\s+)?social\s*club|수요(?:일)?\s*(?:발보아|소셜)|수쏘/i, priority: 1, runOrder: -0.9, notes: '공식 계정의 수요일 Balboa in Social Club만 수집한다. 승인 연결 표본으로 95%를 검증하기 전에는 자동등록 준비 판정을 차단한다.' }),
  ...
  source({ id: 'swingscandal-cafe', name: '스윙스캔들', scope: 'swing', genre: 'swing', type: 'naver_cafe', url: 'https://cafe.naver.com/f-e/cafes/14933600/menus/501?viewType=I', venue: '사보이볼룸', autoRegistrationPolicy: 'shadow', autoRegistrationAllowedActivityTypes: ['social'], priority: 1 }),
  source({ id: 'kyungsunghall', name: '경성홀', scope: 'swing', genre: 'swing', type: 'instagram', url: 'https://www.instagram.com/kyungsunghall/', venue: '경성홀', autoRegistrationPolicy: 'shadow', autoRegistrationAllowedActivityTypes: ['social'], priority: 1 }),
  ...
  source({ id: 'swingfriends-cafe', name: '스윙프렌즈 카페', scope: 'swing', genre: 'swing', type: 'naver_cafe', url: 'https://cafe.naver.com/f-e/cafes/10026855/menus/85?viewType=L', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: [], priority: 2, notes: '복수 장소 이력이 있어 실제 장소 명시와 승인 정확도 95%가 모두 검증되기 전에는 자동등록 준비 판정을 차단한다.' }),
  ...
  source({ id: 'swing_friends', name: '스윙프렌즈 인스타그램', scope: 'swing', genre: 'swing', type: 'instagram', url: 'https://www.instagram.com/swing_friends/', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: [], priority: 2, notes: '포스터/본문에서 날짜·장소가 함께 확인되고 승인 정확도 95%가 검증되기 전에는 자동등록 준비 판정을 차단한다.' }),
  ...
  source({ id: 'swingtown-cafe', name: '스윙타운', scope: 'swing', genre: 'swing', type: 'naver_cafe', url: 'https://cafe.naver.com/f-e/cafes/10342583/menus/264?viewType=L', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: [], priority: 2, runOrder: -0.45, notes: '단체명을 장소로 대체하지 않는다. 실제 장소 명시와 승인 정확도 95%가 모두 검증되기 전에는 자동등록 준비 판정을 차단한다.' }),
  source({ id: 'sweetyswing-lessons', name: '스위티스윙 공지/신청', scope: 'swing', genre: 'swing', type: 'daum_cafe', url: 'https://m.cafe.daum.net/sweetyswing/5ngW', autoRegistrationPolicy: 'shadow', autoRegistrationVenuePolicy: 'explicit', autoRegistrationAllowedActivityTypes: [], priority: 2, notes: '미래 시작일과 실제 장소가 명시되고 승인 정확도 95%가 검증되기 전에는 자동등록 준비 판정을 차단한다.' }),
...
export function findSourceByUrl(url = '') {
  ...
  return collectionSources.find((item) => {
    ...
    const sameHostSources = collectionSources.filter((sourceItem) => {
      try {
        return new URL(sourceItem.url).hostname.replace(/^www\./, '') === hostname;
      } catch {
        return false;
      }
    });
    return sameHostSources.length === 1 && normalized.includes(hostname);
  }) || null;
}
...
export function getAutomationSourceList(profile = 'swing-daily') {
  ...
  return getCollectionSourcesForProfile(normalized).map((item) => ({
    ...
    venue: item.venue,
    autoRegistrationPolicy: item.autoRegistrationPolicy,
    autoRegistrationVenuePolicy: item.autoRegistrationVenuePolicy,
    autoRegistrationAllowedActivityTypes: item.autoRegistrationAllowedActivityTypes,
