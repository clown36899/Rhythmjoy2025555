...
export const collectionSources = [
  ...
  source({ id: 'benefit-search-sale-event', name: '판매 이벤트 검색', scope: 'swing', genre: 'swing', type: 'benefit_search', url: 'https://www.google.com/search?q=site%3Ainstagram.com+%EC%8A%A4%EC%9C%99%EB%8C%84%EC%8A%A4+%ED%8C%90%EB%A7%A4+%EC%9D%B4%EB%B2%A4%ED%8A%B8', query: 'site:instagram.com 스윙댄스 판매 이벤트', benefitKind: 'sale_event', priority: 3, runOrder: 0, notes: '3단계 혜택 전용 검색. 실제 Instagram 게시물 본문·날짜·원본 이미지를 다시 확인한다.' }),
  ...[
