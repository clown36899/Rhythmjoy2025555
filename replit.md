...
- **위치**: 달력 바로 아래 Tools Panel 영역 (~1035-1127줄)
- **주요 버튼**:
  - 달력 접기/펴기 버튼: ~1037-1074줄
  - 정렬 버튼 (랜덤/시간/제목/최신): ~1079-1097줄
  - 검색 버튼: ~1099-1108줄
  - 달력 전체화면 버튼: ~1110-1126줄
- **검색 모달**: `src/pages/home/components/EventList.tsx` (~1995-2077줄)
- **정렬 모달**: `src/pages/home/components/EventList.tsx` (~1952-1992줄)
