...
const AUTOMATIC_EXPLICIT_EVENT_PATTERN = /행사|졸업\s*(?:공연|파티)|졸공|대회|컴피티션|챔피언십|챔피언스?\s*컵|competition|graduation\s*(?:show|party|performance)|championship|tournament|contest|\bbattle\b|\bcup\b/i;
